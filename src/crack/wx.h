...
#define TO_WECHAT_WSTRING(p) ((wb_wx::PWeChatWString)(p))
...
#define WECHAT_CONTACT_ITEM_WXID(CONTACT_ITEM) (TO_WECHAT_WSTRING(reinterpret_cast<uint8_t*>(CONTACT_ITEM) + WECHAT_CONTACT_ITEM_WXID_OFFSET))
#define WECHAT_CONTACT_ITEM_WXNUMBER(CONTACT_ITEM) (TO_WECHAT_WSTRING(reinterpret_cast<uint8_t*>(CONTACT_ITEM) + WECHAT_CONTACT_ITEM_WXNUMBER_OFFSET))
#define WECHAT_CONTACT_ITEM_REMARK(CONTACT_ITEM) (TO_WECHAT_WSTRING(reinterpret_cast<uint8_t*>(CONTACT_ITEM) + WECHAT_CONTACT_ITEM_REMARK_OFFSET))
#define WECHAT_CONTACT_ITEM_NICKNAME(CONTACT_ITEM) (TO_WECHAT_WSTRING(reinterpret_cast<uint8_t*>(CONTACT_ITEM) + WECHAT_CONTACT_ITEM_NICKNAME_OFFSET))
